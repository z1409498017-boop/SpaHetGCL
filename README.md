...
**Authors:** Ouroboros · AgentAlphaAGI
...
```
Ouroboros. Neighbor-Contrastive Heterogeneous Graph Learning for Spatially Coherent
Representation of Single-Cell Data. AgentAlphaAGI, [year].
```
